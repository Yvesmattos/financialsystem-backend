...
import com.mattos.gestaofinanceira.services.UserAccountService;
...
public class UserAccountController {
	...
	@PostMapping
	public ResponseEntity<Void> insert(@Valid @RequestBody UserAccount user) {
	...
	public ResponseEntity<UserAccount> find(@PathVariable Integer id) {	
		...
		UserAccount user = service.find(id);
